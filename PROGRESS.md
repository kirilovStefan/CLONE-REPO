...
- [ ] **NEXT: Big integration** — barbers / locations / services / calendar → database, plus per-barber service checkboxes (`barber_services`)
...
- _2026-05-25_: Confirmed `barber_services` + all 11 tables live in Neon (production
  branch). Created this tracker and corrected stale claims in CLAUDE.md. Next up:
  the big integration.
